...
const ScoringTab = () => {
    ...
    datasets: [
      {
        ...
        backgroundColor: 'rgba(72, 61, 139, 0.2)', // Adjust color for the filled area
        borderColor: 'rgba(72, 61, 139, 1)', // Adjust color for the border
        borderWidth: 1
      }
    ]
  }
  ...
  const options = {
    ...
    plugins: {
      legend: {
        display: false // Hide the legend if you don't want the label on the chart
      }
    }
  }
